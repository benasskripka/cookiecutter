      ...
      messages: [
        {
          ...
          TASK:
          Generate a single, inviting sentence (max 25 words) summarizing why these specific 4 properties are great matches.
          ...
          GUIDELINES:
          - Look for patterns in the "highlight" and "amenities" fields.
          - If they share amenities (e.g., all have pools), mention that.
          - If the highlights mention specific locations or views, mention that.
          - Tone: Professional but inviting.
          - Format: "The highlighted {location/type} rentals stand out for {feature 1}, {feature 2}, and {feature 3}."
