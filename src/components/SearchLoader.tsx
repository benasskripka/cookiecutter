    ...
    <div className="w-[205px] h-[205px]">
      <svg viewBox="0 0 205 205" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-full">
        <g id="Component 13">
          ...
          >
            <path d="M146.72 108.847C149.624 109.422 151.436 112.333 150.67 115.193C149.908 118.035 146.913 119.652 144.119 118.727L121.521 111.25L123.4 104.236L146.72 108.847Z" fill="#0A4EAA" />
            ...
            <path d="M115.463 126.477C101.912 134.301 84.5835 129.658 76.7594 116.106C68.9354 102.555 73.5785 85.2262 87.1302 77.4022C100.682 69.5782 118.01 74.2213 125.834 87.7729C133.658 101.325 129.015 118.653 115.463 126.477Z" fill="#0A4EAA" />
