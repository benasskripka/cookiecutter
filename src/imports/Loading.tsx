import svgPaths from "./svg-6jro8397q2";
...
function Content17() {
  return (
    <div className="box-border content-stretch flex flex-col h-[718px] items-start pb-[24px] pt-0 px-0 relative shrink-0 w-[880px] overflow-y-auto" data-name="Content">
      <ContentWithLoadMore />
    </div>
  );
}
...
function MaxWrapper() {
  return (
    <div className="absolute content-stretch flex h-[1601px] items-start justify-center left-0 overflow-clip top-[156px] w-[1724px]" data-name="Max wrapper">
      <Content18 />
    </div>
  );
}
...
function IconGlyphTune() {
  return (
    <div className="relative shrink-0 size-[22px]" data-name="Icon glyph / tune">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 22 22">
        <g id="Icon glyph / tune">
          <g id="Glyph">
            <path clipRule="evenodd" d={svgPaths.p3f50ef00} fill="var(--fill-0, black)" fillRule="evenodd" />
            <path clipRule="evenodd" d={svgPaths.p18b40200} fill="var(--fill-0, black)" fillRule="evenodd" />
          </g>
        </g>
      </svg>
    </div>
...
function Search() {
  return (
    <div className="bg-white relative rounded-[32px] shrink-0 size-[50px]" data-name="search">
      <div className="box-border content-stretch flex gap-[8px] items-center justify-center overflow-clip p-[12px] relative rounded-[inherit] size-[50px]">
        <IconGlyphTune />
      </div>
      <div aria-hidden="true" className="absolute border border-[rgba(0,0,0,0.1)] border-solid inset-[-1px] pointer-events-none rounded-[33px]" />
    </div>
  );
}
  ...
  return (
    <div className="relative shrink-0 size-[20px]" data-name="Icon">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g clipPath="url(#clip0_3_14918)" id="Icon" opacity="0.75">
          <path d={svgPaths.p34a07370} fill="var(--fill-0, #212121)" id="Union" />
        </g>
        <defs>
          <clipPath id="clip0_3_14918">
...
function Frame7() {
  return (
    <div className="absolute content-stretch flex gap-[12px] items-center left-[26px] top-[20px]">
      <Icon />
      <p className="font-['CentraNo2',sans-serif] font-medium leading-[18px] not-italic relative shrink-0 text-[14px] text-black text-center text-nowrap whitespace-pre">Santa Fe traditional homes</p>
    </div>
  );
}
...
function Icon1() {
  return (
    <div className="relative shrink-0 size-[20px]" data-name="Icon">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g clipPath="url(#clip0_3_14940)" id="Icon" opacity="0.75">
          <path d={svgPaths.p31076400} fill="var(--fill-0, #212121)" id="Union" />
        </g>
        <defs>
          <clipPath id="clip0_3_14940">
            <rect fill="white" height="20" width="20" />
          </clipPath>
        </defs>
      </svg>
...
function Icon2() {
  return (
    <div className="relative shrink-0 size-[20px]" data-name="Icon">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g clipPath="url(#clip0_3_14877)" id="Icon" opacity="0.75">
...
function Frame6() {
  return (
    <div className="bg-white h-[60px] relative rounded-[64px] shrink-0 w-[796px]">
      <div className="h-[60px] overflow-clip relative rounded-[inherit] w-[796px]">
        <ButtonContainer />
      ...
      <div aria-hidden="true" className="absolute border border-[#dfe0e4] border-solid inset-0 pointer-events-none rounded-[64px]" />
    </div>
  );
}
...
function Controls() {
  return (
    <div className="absolute bg-white box-border content-stretch flex gap-[16px] items-center justify-center left-0 px-[24px] py-[16px] shadow-[0px_5px_20px_0px_rgba(0,0,0,0.1)] top-[64px] w-[1724px]" data-name="Controls">
      <Search />
      <Frame6 />
    </div>
  );
    ...
    <div className="relative shrink-0 size-[50px]" data-name="search">
      <div className="absolute inset-[-22%_-32%_-42%_-32%]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 82 82">
          <g filter="url(#filter0_d_3_14873)" id="search">
            ...
            <path d={svgPaths.pd0deb80} fill="var(--fill-0, black)" id="Union" />
          </g>
          <defs>
            <filter colorInterpolationFilters="sRGB" filterUnits="userSpaceOnUse" height="82" id="filter0_d_3_14873" width="82" x="0" y="0">
              ...
              <feBlend in2="BackgroundImageFix" mode="normal" result="effect1_dropShadow_3_14873" />
              <feBlend in="SourceGraphic" in2="effect1_dropShadow_3_14873" mode="normal" result="shape" />
            </filter>
          </defs>
        </svg>
      </div>
...
function ButtonContainer1() {
  return (
    <div className="absolute bg-[#1668e3] box-border content-stretch flex gap-[8px] items-center justify-center left-[654px] overflow-clip p-[12px] rounded-[40000px] top-[8px]" data-name="_ / Button / Container">
      <ButtonIcon1 />
    </div>
  );
}
...
function Frame10() {
  return (
    <div className="absolute content-stretch flex gap-[12px] items-center left-[24px] top-[20px]">
      <p className="font-['CentraNo2',sans-serif] font-medium leading-[18px] not-italic relative shrink-0 text-[14px] text-[rgba(0,0,0,0.75)] text-center text-nowrap whitespace-pre">“Cozy feeling inside”</p>
    </div>
  );
}
...
function Frame11() {
  return (
    <div className="bg-white h-[58px] opacity-0 relative rounded-[32px] shrink-0 w-px">
      <div className="h-[58px] overflow-clip relative rounded-[inherit] w-px">
        <ButtonContainer1 />
        <Frame10 />
      </div>
...
function Pill() {
  return (
    <div className="bg-white relative rounded-[32px] shrink-0" data-name="pill1">
      <div className="box-border content-stretch flex gap-[8px] items-center overflow-clip px-[24px] py-[16px] relative rounded-[inherit]">
        <div className="flex flex-col font-['CentraNo2',sans-serif] font-medium justify-center leading-[0] not-italic relative shrink-0 text-[#191e3b] text-[14px] text-nowrap">
          <p className="leading-[1.25] whitespace-pre">King beds in all bedrooms</p>
        </div>
      </div>
      <div aria-hidden="true" className="absolute border border-[rgba(0,0,0,0.1)] border-solid inset-[-1px] pointer-events-none rounded-[33px] shadow-[0px_5px_15px_0px_rgba(0,0,0,0.1)]" />
    </div>
...
function Pill4() {
  return (
    <div className="bg-white relative rounded-[32px] shrink-0" data-name="pill2">
      <div className="box-border content-stretch flex gap-[8px] items-center overflow-clip px-[24px] py-[16px] relative rounded-[inherit]">
        <div className="flex flex-col font-['CentraNo2',sans-serif] font-medium justify-center leading-[0] not-italic relative shrink-0 text-[#191e3b] text-[14px] text-nowrap">
          <p className="leading-[1.25] whitespace-pre">Slightly cheaper</p>
        </div>
      </div>
      <div aria-hidden="true" className="absolute border border-[rgba(0,0,0,0.1)] border-solid inset-[-1px] pointer-events-none rounded-[33px] shadow-[0px_5px_15px_0px_rgba(0,0,0,0.1)]" />
    </div>
...
function Pill5() {
  return (
    <div className="bg-white relative rounded-[32px] shrink-0" data-name="pill3">
      <div className="box-border content-stretch flex gap-[8px] items-center overflow-clip px-[24px] py-[16px] relative rounded-[inherit]">
        <div className="flex flex-col font-['CentraNo2',sans-serif] font-medium justify-center leading-[0] not-italic relative shrink-0 text-[#191e3b] text-[14px] text-nowrap">
          <p className="leading-[1.25] whitespace-pre">Easy walk to trails</p>
        </div>
      </div>
      <div aria-hidden="true" className="absolute border border-[rgba(0,0,0,0.1)] border-solid inset-[-1px] pointer-events-none rounded-[33px] shadow-[0px_5px_15px_0px_rgba(0,0,0,0.1)]" />
    </div>
...
function Pill6() {
  return (
    <div className="bg-white relative rounded-[32px] shrink-0" data-name="pill3">
      <div className="box-border content-stretch flex gap-[8px] items-center overflow-clip px-[24px] py-[16px] relative rounded-[inherit]">
        <div className="flex flex-col font-['CentraNo2',sans-serif] font-medium justify-center leading-[0] not-italic relative shrink-0 text-[#191e3b] text-[14px] text-nowrap">
          <p className="leading-[1.25] whitespace-pre">Extra cozy vibes</p>
        </div>
      </div>
      <div aria-hidden="true" className="absolute border border-[rgba(0,0,0,0.1)] border-solid inset-[-1px] pointer-events-none rounded-[33px] shadow-[0px_5px_15px_0px_rgba(0,0,0,0.1)]" />
    </div>
...
export default function Loading() {
  return (
    <div className="bg-white overflow-clip relative rounded-[24px] size-full" data-name="Loading">
