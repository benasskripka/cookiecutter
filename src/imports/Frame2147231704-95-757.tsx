import svgPaths from "./svg-nvrcqljctv";
...
function Icon1() {
  return (
    <div className="absolute inset-0 overflow-clip" data-name="✏️ Icon">
      <div className="absolute aspect-[16.000696182250977/19] left-[16.66%] right-[16.67%] top-[calc(50%-0.53px)] translate-y-[-50%]" data-name="Glyph">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 13.4739 15.9996">
          <path d={svgPaths.p17e6d700} fill="var(--fill-0, #191E3B)" id="Glyph" />
        </svg>
      </div>
    </div>
  );
...
function Pill() {
  return (
    <div className="bg-[#f2f8fd] content-stretch flex items-center justify-between overflow-clip px-[24px] py-[16px] relative rounded-[32px] shrink-0 w-[393px]" data-name="pill2">
      <Frame11 />
      <div className="flex h-[18.773px] items-center justify-center relative shrink-0 w-[20.03px]" style={{ "--transform-inner-width": "0", "--transform-inner-height": "19" } as React.CSSProperties}>
        <div className="flex-none rotate-[359.907deg]">
...
function ButtonPrimaryIconOnly3() {
  return (
    <div className="h-[18.74px] relative w-[20px]" data-name="Button / Primary / Icon only">
...
function ButtonContainerIconOnly4() {
  return (
    <div className="absolute h-[18.238px] left-[-10.8px] top-[-0.25px] w-[40.42px]" data-name="_ / Button / Container / Icon only">
      <div className="absolute left-0 size-[40.42px] top-[-10.59px]" data-name="Background">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 32 32">
...
function ButtonPrimaryIconOnly4() {
  return (
    <div className="h-[18.74px] relative w-[20px]" data-name="Button / Primary / Icon only">
      <ButtonContainerIconOnly4 />
    </div>
  );
}
...
function ButtonContainerIconOnly5() {
  return (
    <div className="absolute h-[18.238px] left-[-10.8px] top-[-0.25px] w-[40.42px]" data-name="_ / Button / Container / Icon only">
      <div className="absolute left-0 size-[40.42px] top-[-10.59px]" data-name="Background">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 32 32">
...
function ButtonPrimaryIconOnly5() {
  return (
    <div className="h-[18.74px] relative w-[20px]" data-name="Button / Primary / Icon only">
      <ButtonContainerIconOnly5 />
    </div>
  );
}
...
function Frame12() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[12px] items-start left-[24px] top-[101px] w-[393px]">
      <Frame5 />
      <Frame8 />
      <Frame9 />
    </div>
